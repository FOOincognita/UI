...
def generate_response(prompt):
    ...
    if "[BIO]" in response:
        bio_prompt   = response.split("[BIO]")[1]
        bio_response = get_bio_response(bio_prompt)
...
def runHMA():
    ...
    print()
    intro = print("[USER] Howdy! I'm an assistant here to help answer any questions you might have. I can provide information on a wide range of topics, and if there's a question that requires specific biomedical knowledge, I can consult with a biomedical AI model to ensure you get the most accurate answer possible. How can I assist you today?")
    print()
    prompt = input("> ")
    print()
